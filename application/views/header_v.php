                        ...
                        <div class="dropdown me-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationDropdown" style="width: 350px; max-height: 400px; overflow-y: auto;">
                                <div class="dropdown-header d-flex justify-content-between align-items-center">
                                    <strong>알림</strong>
                                    <button class="btn btn-sm btn-link text-muted p-0" id="markAllReadBtn">모두 읽음</button>
                                </div>
                                ...
                                <div class="dropdown-divider"></div>
                                <a href="/notification" class="dropdown-item text-center text-primary">모든 알림 보기</a>
                            </div>
                        </div>
                        <!-- 로그인된 상태 -->
